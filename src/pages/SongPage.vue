    ...
    <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      >
        ...
        <el-form-item prop="lyric" label="歌词" size="mini">
          <el-input  type="textarea" v-model="registerForm.lyric" placeholder="歌词"></el-input>
        </el-form-item>
      </el-form>
...
import {getSongOfSingerId, updateSongMsg, deleteSong, setSinger,addSong} from '../api/index'
...
export default {
  ...
  methods: {
    ...
    // 更新歌曲图片
    uploadUrl (id) {
      return `${this.$store.state.HOST}/client/song/updatePic?id=${id}`
    },
    // 更新歌曲url
    uploadSongUrl (id) {
      return `${this.$store.state.HOST}/client/song/updateUrl?id=${id}`
    },
    ...
    addSong () {
      ...
      params.append('name', this.singerName+'-'+this.registerForm.name)
      params.append('singerId', this.singerId)
      params.append('introduction', this.registerForm.introduction)
      if(!this.registerForm.lyric){
        params.append('lyric',  '[00:00:00]暂无歌词')
      }else{
        params.append('lyric',  this.registerForm.lyric)
      }
      addSong(params)
        .then(res => {
          if (res.code === 1) {
